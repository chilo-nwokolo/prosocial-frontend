...
const journalTitles = {
	...
	'Greatest Personal Achievement': 'What is your greatest personal achievement?',
	'Hardest Learned Life Lesson': 'What is the hardest lesson you have learned in life?',
		...
		<QueryContainer loading={loading || meLoading} error={error || meError}>
			<Flex flexDir="column">
				...
				<form onSubmit={formik.handleSubmit}>
					<Text mt="2">{journalTitles[getJournalTitle() as keyof typeof journalTitles]}</Text>
					<Textarea
						name="input"
