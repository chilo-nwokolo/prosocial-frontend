...
export default function PersonalityQuestionsPage({
  ...
  const { formik, router, sectionQuestions, loading } =
    usePersonalityQuestionsPage({
  ...
  return (
    <Flex flexDir="column" gap="8" mb="5">
      ...
      <Flex flexDir="column" gap="5">
        ...
        <Text>
          Below are a number of personality traits that may or may not apply to
          you. Do your best to choose the option that best reflects who you are
          as a person.
        </Text>
      </Flex>
